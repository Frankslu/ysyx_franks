...
#endif
                VL_FATAL_MT("vsrc/mem.v", 2, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vmem___024root___ctor_var_reset(Vmem___024root* vlSelf) {
    ...
    vlSelf->mem__DOT__Memory_w_rdata = VL_RAND_RESET_I(32);
    vlSelf->__Vtask_mem__DOT__Memory__DOT__pmem_write__0__rdata = 0;
    vlSelf->__Vtask_mem__DOT__Memory__DOT__pmem_read__1__rdata = 0;
}
