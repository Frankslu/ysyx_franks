...
VL_INLINE_OPT void VMain___024root___nba_sequent__TOP__0(VMain___024root* vlSelf) {
    ...
    vlSelf->Main__DOT__cpucore__DOT__pIF__DOT__pc = 
        ((IData)(vlSelf->Main__DOT__cpucore_reset_REG)
          ? 0x1c000000U : ((((0U == (IData)(vlSelf->Main__DOT__cpucore__DOT__ID_toes_bits_inst_name)) 
    ...
    vlSelf->Main__DOT__cpucore_reset_REG = vlSelf->reset;
    if ((1U & (~ (IData)(vlSelf->Main__DOT__cpucore_reset_REG)))) {
    ...
    VMain___024root____Vdpiimwrap_Main__DOT__cpucore__DOT__ID__DOT__reg___DOT__inst_exec_once__DOT__inst_exec_once_TOP(
                                                                                (1U 
                                                                                & (~ (IData)(vlSelf->Main__DOT__cpucore_reset_REG))), vlSelf->Main__DOT__iram_rdata, vlSelf->Main__DOT__cpucore__DOT__pIF__DOT__pc);
...
#endif
                    VL_FATAL_MT("/home/franks/ysyx-workbench/npc/vsrc/Main.v", 1412, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/franks/ysyx-workbench/npc/vsrc/Main.v", 1412, "", "NBA region did not converge.");
            }
