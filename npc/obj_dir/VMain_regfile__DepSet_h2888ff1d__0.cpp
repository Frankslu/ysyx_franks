...
VL_INLINE_OPT void VMain_regfile___ico_sequent__TOP__Main__cpucore__ID__reg___3(VMain_regfile* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VMain_regfile___ico_sequent__TOP__Main__cpucore__ID__reg___3\n"); );
    // Body
