...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    // Init
    QData/*63:0*/ ALU__DOT___io_res_T_11;
    ALU__DOT___io_res_T_11 = 0;
    // Body
    ...
    ALU__DOT___io_res_T_11 = ((9U == (IData)(vlSelf->io_alu_op))
...
#endif
                VL_FATAL_MT("vsrc/Main.v", 998, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("vsrc/Main.v", 998, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("vsrc/Main.v", 998, "", "NBA region did not converge.");
            }
