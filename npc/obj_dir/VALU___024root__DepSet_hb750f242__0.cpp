...
VL_INLINE_OPT void VALU___024root___ico_sequent__TOP__0(VALU___024root* vlSelf) {
    ...
    ALU__DOT__mul_pre = 0;
    // Body
    ALU__DOT__or_res = (vlSelf->io_src1 | vlSelf->io_src2);
    ALU__DOT__mul_pre = ((QData)((IData)(vlSelf->io_src1)) 
                         * (QData)((IData)(vlSelf->io_src2)));
    ALU__DOT__add_sub = ((2U == (IData)(vlSelf->io_alu_op)) 
                         | ((3U == (IData)(vlSelf->io_alu_op)) 
                            | (4U == (IData)(vlSelf->io_alu_op))));
    ALU__DOT__add_res = (0x1ffffffffULL & ((QData)((IData)(vlSelf->io_src1)) 
                                           + ((QData)((IData)(
                                                              ((IData)(ALU__DOT__add_sub)
                                                                ? 
                                                               (~ vlSelf->io_src2)
                                                                : vlSelf->io_src2))) 
                                              + (QData)((IData)(ALU__DOT__add_sub)))));
