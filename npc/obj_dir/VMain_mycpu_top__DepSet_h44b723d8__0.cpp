...
VL_INLINE_OPT void VMain_mycpu_top___ico_sequent__TOP__Main__cpucore__11(VMain_mycpu_top* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        VMain_mycpu_top___ico_sequent__TOP__Main__cpucore__11\n"); );
    // Body
