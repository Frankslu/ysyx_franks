...
VL_ATTR_COLD void VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__2(VMain_IF_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__2\n"); );
    // Body
...
VL_ATTR_COLD void VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__3(VMain_IF_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__3\n"); );
    // Body
...
VL_ATTR_COLD void VMain_IF_stage___ctor_var_reset(VMain_IF_stage* vlSelf) {
    ...
    vlSelf->__PVT__tods_bits_next_pc = VL_RAND_RESET_I(32);
    ...
    vlSelf->__PVT__fs_bits_next_pc = VL_RAND_RESET_I(32);
}
