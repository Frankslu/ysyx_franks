...
VL_INLINE_OPT void VMain_WB_stage___ico_sequent__TOP__Main__cpucore__WB__1(VMain_WB_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_WB_stage___ico_sequent__TOP__Main__cpucore__WB__1\n"); );
    // Body
...
VL_INLINE_OPT void VMain_WB_stage___ico_sequent__TOP__Main__cpucore__WB__2(VMain_WB_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_WB_stage___ico_sequent__TOP__Main__cpucore__WB__2\n"); );
    // Body
