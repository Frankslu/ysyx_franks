...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__1(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__1\n"); );
    // Body
...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__2(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__2\n"); );
    // Body
...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__3(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__3\n"); );
    // Body
...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__4(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__4\n"); );
    // Body
...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__5(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__5\n"); );
    // Body
...
VL_INLINE_OPT void VMain_Main___ico_sequent__TOP__Main__6(VMain_Main* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+      VMain_Main___ico_sequent__TOP__Main__6\n"); );
    // Body
