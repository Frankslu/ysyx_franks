...
void VALU___024root__trace_chg_sub_0(VALU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+12,(vlSelf->io_alu_op),5);
    bufp->chgIData(oldp+13,(vlSelf->io_src1),32);
    bufp->chgIData(oldp+14,(vlSelf->io_src2),32);
    bufp->chgIData(oldp+15,(vlSelf->io_res),32);
    bufp->chgBit(oldp+16,((1U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+17,((2U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+18,((3U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+19,((4U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+20,((5U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+21,((6U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+22,((7U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+23,((8U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+24,((9U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+25,((0xaU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+26,((0xbU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+27,((0xcU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+28,((0xdU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+29,((0xeU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+30,((0xfU == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+31,((0x10U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+32,((0x12U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+33,((0x11U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+34,((0x13U == (IData)(vlSelf->io_alu_op))));
    bufp->chgBit(oldp+35,((1U & (((~ (vlSelf->io_src2 
                                      >> 0x1fU)) & 
                                  (vlSelf->io_src1 
                                   >> 0x1fU)) | ((~ 
                                                  ((vlSelf->io_src1 
                                                 ...
                                                 & (IData)(
                                                           (vlSelf->ALU__DOT__add_res 
                                                            >> 0x1fU)))))));
    bufp->chgIData(oldp+36,((vlSelf->io_src1 & vlSelf->io_src2)),32);
    bufp->chgIData(oldp+37,((vlSelf->io_src1 ^ vlSelf->io_src2)),32);
    bufp->chgQData(oldp+38,((0x7fffffffffffffffULL 
    ...
    bufp->chgQData(oldp+42,(((((QData)((IData)((((vlSelf->io_src1 
                                                  >> 0x1fU) 
                                                 & (0xbU 
                                                    == (IData)(vlSelf->io_alu_op)))
                                                 ? 0xffffffffU
    ...
    bufp->chgIData(oldp+44,((IData)((VL_MULS_QQQ(64, 
