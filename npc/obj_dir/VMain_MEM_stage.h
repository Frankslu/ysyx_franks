...
class VMain_MEM_stage final : public VerilatedModule {
  public:
    ...
    VL_IN8(__PVT__ms_bits_rf_we,0,0);
    VL_IN8(__PVT__ms_bits_rf_waddr,4,0);
    VL_IN8(__PVT__ms_bits_dpi_c_is_break,0,0);
    VL_OUT8(__PVT__tows_valid,0,0);
    VL_OUT8(__PVT__tows_bits_rf_we,0,0);
    VL_OUT8(__PVT__tows_bits_rf_waddr,4,0);
    VL_OUT8(__PVT__tows_bits_dpi_c_is_break,0,0);
    CData/*7:0*/ __PVT___mem_rdata_sign_T;
    SData/*15:0*/ __PVT___mem_rdata_sign_T_1;
    VL_IN(__PVT__ms_bits_alu_res,31,0);
    VL_IN(__PVT__ms_bits_dpi_c_inst,31,0);
    VL_IN(__PVT__ms_bits_dpi_c_next_pc,31,0);
    VL_OUT(__PVT__tows_bits_rf_wdata,31,0);
    VL_OUT(__PVT__tows_bits_dpi_c_inst,31,0);
    VL_OUT(__PVT__tows_bits_dpi_c_next_pc,31,0);
