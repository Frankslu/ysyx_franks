...
class VMain_EX_stage final : public VerilatedModule {
  public:
    ...
    VL_IN(__PVT__es_bits_dpi_c_inst,31,0);
    VL_IN(__PVT__es_bits_dpi_c_next_pc,31,0);
    VL_OUT(__PVT__toms_bits_alu_res,31,0);
    VL_OUT(__PVT__toms_bits_dpi_c_inst,31,0);
    VL_OUT(__PVT__toms_bits_dpi_c_next_pc,31,0);
