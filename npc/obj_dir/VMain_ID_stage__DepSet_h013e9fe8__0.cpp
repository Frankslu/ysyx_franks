...
VL_INLINE_OPT void VMain_ID_stage___ico_sequent__TOP__Main__cpucore__ID__0(VMain_ID_stage* vlSelf) {
...
VL_INLINE_OPT void VMain_ID_stage___ico_sequent__TOP__Main__cpucore__ID__2(VMain_ID_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_ID_stage___ico_sequent__TOP__Main__cpucore__ID__2\n"); );
    // Body
...
VL_INLINE_OPT void VMain_ID_stage___nba_sequent__TOP__Main__cpucore__ID__0(VMain_ID_stage* vlSelf) {
    ...
    vlSelf->__PVT__imm20u = VL_CONCAT_III(32,20,12, 
                                          (0xfffffU 
                                           & VL_SEL_IIII(32, vlSelf->__PVT__ds_bits_inst, 5U, 0x14U)), 0U);
    ...
    vlSelf->__PVT___imm26_sign_T = VL_CONCAT_III(28,5,23, (IData)(vlSelf->__PVT__rj), 
                                                 VL_CONCAT_III(23,5,18, (IData)(vlSelf->__PVT__rd), 
    ...
    vlSelf->__PVT__imm26 = VL_CONCAT_III(32,4,28, (0xfU 
                                                   & VL_REPLICATE_IOI(1,
                                                                      (1U 
                                                                       & VL_BITSEL_IIII(28, vlSelf->__PVT___imm26_sign_T, 0x1bU)), 4U)), vlSelf->__PVT___imm26_sign_T);
    ...
    vlSelf->__PVT__decode_res_orMatrixOutputs_lo_6 
        = VL_CONCAT_III(7,1,6, (IData)(vlSelf->__PVT___decode_res_T_71), 
                        VL_CONCAT_III(6,1,5, (IData)(vlSelf->__PVT___decode_res_T_73), 
                                      VL_CONCAT_III(5,1,4, (IData)(vlSelf->__PVT___decode_res_T_87), 
    ...
    vlSelf->__PVT___decode_res_orMatrixOutputs_T_22 
        = VL_CONCAT_III(3,1,2, (IData)(vlSelf->__PVT___decode_res_T_53), 
    ...
    vlSelf->__PVT___decode_res_orMatrixOutputs_T_16 
        = VL_CONCAT_III(15,1,14, (IData)(vlSelf->__PVT___decode_res_T_1), 
                        VL_CONCAT_III(14,1,13, (IData)(vlSelf->__PVT___decode_res_T_5), 
                                      VL_CONCAT_III(13,1,12, (IData)(vlSelf->__PVT___decode_res_T_11), 
                                                    VL_CONCAT_III(12,1,11, (IData)(vlSelf->__PVT___decode_res_T_17), 
                                                                  VL_CONCAT_III(11,1,10, (IData)(vlSelf->__PVT___decode_res_T_19), 
                                                                                VL_CONCAT_III(10,1,9, (IData)(vlSelf->__PVT___decode_res_T_27), 
                                                                                VL_CONCAT_III(9,1,8, (IData)(vlSelf->__PVT___decode_res_T_47), 
                                                                                VL_CONCAT_III(8,1,7, (IData)(vlSelf->__PVT___decode_res_T_65), (IData)(vlSelf->__PVT__decode_res_orMatrixOutputs_lo_6)))))))));
    vlSelf->__PVT___decode_res_orMatrixOutputs_T_18 
        = VL_CONCAT_III(9,1,8, (IData)(vlSelf->__PVT___decode_res_T_55), 
                        VL_CONCAT_III(8,1,7, (IData)(vlSelf->__PVT___decode_res_T_57), 
                                      VL_CONCAT_III(7,1,6, (IData)(vlSelf->__PVT___decode_res_T_63), 
                                                    VL_CONCAT_III(6,1,5, (IData)(vlSelf->__PVT___decode_res_T_65), 
                                                                  VL_CONCAT_III(5,1,4, (IData)(vlSelf->__PVT___decode_res_T_85), 
                                                                                VL_CONCAT_III(4,1,3, (IData)(vlSelf->__PVT___decode_res_T_89), 
                                                                                VL_CONCAT_III(3,1,2, (IData)(vlSelf->__PVT___decode_res_T_91), 
                                                                                VL_CONCAT_III(2,1,1, (IData)(vlSelf->__PVT___decode_res_T_93), (IData)(vlSelf->__PVT___decode_res_T_123)))))))));
    ...
    vlSelf->__PVT___imm_T_10 = ((IData)(vlSelf->__PVT___imm_T_3)
                                 ? 4U : vlSelf->__PVT___imm_T_9);
    vlSelf->__PVT___imm_T_11 = ((IData)(vlSelf->__PVT___imm_T_2)
                                 ? VL_EXTEND_II(32,12, (IData)(vlSelf->__PVT__imm12u))
                                 : vlSelf->__PVT___imm_T_10);
    vlSelf->__PVT___imm_T_12 = ((IData)(vlSelf->__PVT___imm_T_1)
                                 ? vlSelf->__PVT__imm12
                                 : vlSelf->__PVT___imm_T_11);
...
VL_INLINE_OPT void VMain_ID_stage___nba_sequent__TOP__Main__cpucore__ID__1(VMain_ID_stage* vlSelf) {
    ...
    vlSelf->__PVT__reg___05Fio_waddr = ((0xfU == (IData)(vlSelf->__PVT__inst_name))
                                         ? 1U : (IData)(vlSelf->__PVT__torf_rf_waddr));
...
VL_INLINE_OPT void VMain_ID_stage___nba_comb__TOP__Main__cpucore__ID__0(VMain_ID_stage* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMain__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          VMain_ID_stage___nba_comb__TOP__Main__cpucore__ID__0\n"); );
    // Body
    ...
    vlSelf->__PVT___rj_sub_rd_T = (~ vlSelf->__PVT__reg___05Fio_rdata2);
    ...
    vlSelf->__PVT___rj_sub_rd_T_1 = (0x1ffffffffULL 
                                     & (VL_EXTEND_QI(33,32, vlSelf->__PVT__reg___05Fio_rdata1) 
                                        + VL_EXTEND_QI(33,32, vlSelf->__PVT___rj_sub_rd_T)));
