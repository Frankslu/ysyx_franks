...
VL_ATTR_COLD void VMain_ALU___stl_sequent__TOP__Main__cpucore__EXE__alu__2(VMain_ALU* vlSelf);
...
VL_ATTR_COLD void VMain___024root___eval_stl(VMain___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(0U)) {
        ...
        VMain_ALU___stl_sequent__TOP__Main__cpucore__EXE__alu__2((&vlSymsp->TOP__Main__cpucore__EXE__alu));
        ...
        VMain_mycpu_top___stl_sequent__TOP__Main__cpucore__12((&vlSymsp->TOP__Main__cpucore));
