...
VL_ATTR_COLD void VMain_preIF___stl_sequent__TOP__Main__cpucore__pIF__2(VMain_preIF* vlSelf);
...
VL_ATTR_COLD void VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__3(VMain_IF_stage* vlSelf);
...
VL_ATTR_COLD void VMain___024root___eval_stl(VMain___024root* vlSelf) {
    ...
    if (vlSelf->__VstlTriggered.at(0U)) {
        ...
        VMain_preIF___stl_sequent__TOP__Main__cpucore__pIF__2((&vlSymsp->TOP__Main__cpucore__pIF));
        ...
        VMain_IF_stage___stl_sequent__TOP__Main__cpucore__IF__3((&vlSymsp->TOP__Main__cpucore__IF));
