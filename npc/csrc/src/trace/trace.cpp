...
__attribute_maybe_unused__ static Iring_t iring;
...
__attribute_maybe_unused__ extern char* elf_file;
__attribute_maybe_unused__ extern CPU_state cpu;

__attribute_maybe_unused__ static Ering_t ering[ERING_SIZE] = {};
__attribute_maybe_unused__ static int ering_pos = 0;

__attribute_maybe_unused__ static Dring_t dring[DRING_SIZE] = {};
__attribute_maybe_unused__ static int dring_pos = 0;
